...
faiss_author_index_path = os.path.join(FAISS_PATH, "afaiss.index")
faiss_author_metadata_path = os.path.join(FAISS_PATH, "ameta.json")
faiss_author_vectors_path = os.path.join(FAISS_PATH, "achunks.npy")
